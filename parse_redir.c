...
{
	return (redir_c(o_cmd, cmd, end_cmd, O_RDONLY));
}

t_cmd	*handle_redir_more(t_cmd *o_cmd, char *cmd, char *end_cmd)
{
	return (redir_c(o_cmd, cmd, end_cmd, O_WRONLY | O_CREAT));
}

t_cmd	*handle_redir_more_append(t_cmd *o_cmd, char *cmd, char *end_cmd)
{
	return (redir_c(o_cmd, cmd, end_cmd, O_APPEND | O_CREAT));
}
